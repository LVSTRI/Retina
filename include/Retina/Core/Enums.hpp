...
namespace Retina {
    namespace Detail {
        ...
        RETINA_NATIVE_ENUM_COUNTERPART_SPECIALIZATION(VkBorderColor, EBorderColor);
    ...
    #define RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(E, T, F) \
    ...
    RETINA_ENUM_TO_STRING_BASE_AND_CONVERSION_OVERLOAD(VkBorderColor, EBorderColor);
    ...
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkImageAspectFlags, EImageAspect, VkImageAspectFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkImageCreateFlags, EImageCreateFlag, VkImageCreateFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkSampleCountFlags, ESampleCount, VkSampleCountFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkImageUsageFlags, EImageUsage, VkImageUsageFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkMemoryPropertyFlags, EMemoryProperty, VkMemoryPropertyFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkBufferCreateFlags, EBufferCreateFlag, VkBufferCreateFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkColorComponentFlags, EColorComponent, VkColorComponentFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkShaderStageFlags, EShaderStage, VkShaderStageFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkCullModeFlags, ECullMode, VkCullModeFlagBits);
    ...
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkDescriptorSetLayoutCreateFlags, EDescriptorLayoutCreateFlag, VkDescriptorSetLayoutCreateFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkCommandPoolCreateFlags, ECommandPoolCreateFlag, VkCommandPoolCreateFlagBits);
    RETINA_FLAG_BITS_ENUM_TO_STRING_OVERLOAD(VkDescriptorBindingFlags, EDescriptorBindingFlag, VkDescriptorBindingFlagBits);
